...
conn.sendMessage(m.chat, { sticker: result }, { quoted: msg })
}
}
for (let anju of vien){
if (budy === anju){
result = fs.readFileSync(`./media/audio/${anju}.mp3`)
conn.sendMessage(m.chat, { audio: result, mimetype: 'audio/mp4', ptt: true }, { quoted: msg })     
}
}
for (let anjh of imagi){
if (budy === anjh){
result = fs.readFileSync(`./media/image/${anjh}.jpg`)
conn.sendMessage(m.chat, { image: result }, { quoted: msg })
}
}
for (let anjo of videox){
if (budy === anjo){
result = fs.readFileSync(`./media/video/${anjo}.mp4`)
conn.sendMessage(m.chat, { video: result }, { quoted: msg })
}
}
...
case 'addsticker':
            case 'addstiker':
if (!/webp/.test(mime) && !args.join(" ")) return reply(`Reply sticker masukan perintah *${prefix + command} bot*`)
let addsetik = args.join(" ")
setik.push(addsetik)
fs.writeFileSync('./src/sticker.json', JSON.stringify(setik))
await conn.downloadAndSaveMediaMessage(quoted, `./media/sticker/${addsetik}`)
reply(`Tersimpan!!!\n Kirim ${addsetik} untuk melihat sticker! \nKirim ${prefix}stickerlist untuk melihat list!`)                       
break
case 'stickerlist':
            case 'stikerlist': {
...
case 'delsticker':
            case 'delstiker':
if (!args.join(" ")) return reply(`Apa nama sticker?\n contoh: *${prefix + command} bot*`)
let setikdel = args.join(" ")
let of = setik.indexOf(from)
setik.splice(of, 1)
fs.writeFileSync('./src/sticker.json', JSON.stringify(setik))
await fs.unlinkSync(`./media/sticker/${setikdel}.webp`)
reply(`${setikdel} has been deleted! \nKirim ${prefix}stickerlist untuk melihat list!`)                       
break
case 'addimage':
            case 'addimg':
if (!/jpg/.test(mime) && !args.join(" ")) return reply(`Reply Image masukan perintah *${prefix + command} bot*`)
let addimagi = args.join(" ")
imagi.push(addimagi)
fs.writeFileSync('./src/image.json', JSON.stringify(imagi))
await conn.downloadAndSaveMediaMessage(quoted, `./media/image/${addimagi}`)
reply(`Tersimpan!!!\n Kirim ${addimagi} untuk melihat image! \nKirim ${prefix}imagelist untuk melihat list!`)                       
break
case 'listimage':
            case 'imagelist': {
...
case 'delimage':
            case 'delimg':
if (!args.join(" ")) return reply(`Apa nama image?\n contoh: *${prefix + command} bot*`)
let imagedel = args.join(" ")
let offf = imagi.indexOf(from)
imagi.splice(offf, 1)
fs.writeFileSync('./src/image.json', JSON.stringify(imagi))
if (/png/.test(mime)) return await fs.unlinkSync(`./media/image/${imagedel}.png`)
if (/jpg/.test(mime)) return await fs.unlinkSync(`./media/image/${imagedel}.jpg`)
if (/jpeg/.test(mime)) return await fs.unlinkSync(`./media/image/${imagedel}.jpeg`)
reply(`${imagedel} has been deleted! \nKirim ${prefix}imagelist untuk melihat list!`)                       
break
case 'addvid':
            case 'addvideo':
if (!isOwner) return reply(mess.OnlyOwner)
if (!/video/.test(mime) && !args.join(" ")) return reply(`Reply Video masukan perintah *${prefix + command} bot*`)
let addvideox = args.join(" ")
videox.push(addvideox)
fs.writeFileSync('./src/video.json', JSON.stringify(videox))
await conn.downloadAndSaveMediaMessage(quoted, `./media/video/${addvideox}`)
reply(`Tersimpan!!!\n Kirim ${addvideox} untuk melihat video! \nKirim ${prefix}videolist untuk melihat list!`)                       
break
case 'listvideo':
            case 'videolist': {
...
case 'delvid':
            case 'delvideo':
if (!isOwner) return reply(mess.OnlyOwner)
if (!args.join(" ")) return reply(`Apa nama video?\n contoh: *${prefix + command} bot*`)
let videoxdel = args.join(" ")
let ofs = videox.indexOf(from)
videox.splice(ofs, 1)
fs.writeFileSync('./src/video.json', JSON.stringify(videox))
if (/mp4/.test(mime)) return await fs.unlinkSync(`./media/video/${videoxdel}.mp4`)
if (/mkv/.test(mime)) return await fs.unlinkSync(`./media/video/${videoxdel}.mkv`)
if (/gif/.test(mime)) return await fs.unlinkSync(`./media/video/${videoxdel}.gif`)
reply(`${videoxdel} has been deleted! \nKirim ${prefix}videolist untuk melihat list!`)                       
break
case 'addvn':
            case 'addaudio':
if (!isOwner) return reply(mess.OnlyOwner)
if (!/audio/.test(mime) && !args.join(" ")) return reply(`Reply Audio masukan perintah *${prefix + command} bot*`)
let addvn = args.join(" ")
vien.push(addvn)
fs.writeFileSync('./src/audio.json', JSON.stringify(vien))
await conn.downloadAndSaveMediaMessage(quoted, `./media/audio/${addvn}`)
reply(`Tersimpan!!!\n Kirim ${addvn} untuk melihat audio! \nKirim ${prefix}vnlist untuk melihat list!`)                       
break
case 'vnlist':
            case 'listvn': {
...
case 'delvn':
            case 'delaudio':
if (!isOwner) return reply(mess.OnlyOwner)
if (!args.join(" ")) return reply(`Apa nama audio?\n contoh: *${prefix + command} bot*`)
let vndel = args.join(" ")
let offff = vien.indexOf(from)
vien.splice(offff, 1)
fs.writeFileSync('./src/audio.json', JSON.stringify(vien))
if (/mp3/.test(mime)) return await fs.unlinkSync(`./media/audio/${vndel}.mp3`)
if (/m4a/.test(mime)) return await fs.unlinkSync(`./media/audio/${vndel}.m4a`)
if (/opus/.test(mime)) return await fs.unlinkSync(`./media/audio/${vndel}.opus`)
...
const gurbot = '628165458562@s.whatsapp.net'
...
var bg_lexxy = '628165458562@s.whatsapp.net'
...
.then(data => {
var opt = { packname: 'Ini Sticker cuy', author: 'BotTrinity' }
...
break
/*case 'sgif': case 'sticker': case 's': case 'stiker': case 'stc':
if (cekUser("id", sender) == null) return reply(mess.OnlyUser)
if (isImage || isQuotedImage){
var media = await conn.downloadAndSaveMediaMessage(msg, 'foto', `./sticker/${sender}.jpg`)
let encmedia = await conn.sendImageAsSticker(m.chat, media, msg, { packname: 'Ini Sticker cuy', author: 'BotTrinity' })
await fs.unlinkSync(encmedia)
} else if (isVideo || isQuotedVideo) {
if ((quoted.msg || quoted).seconds > 11) return reply('Maksimal 10 detik!')
var media = await conn.downloadAndSaveMediaMessage(msg, 'video', `./sticker/${sender}.mp4`)
let encmedia = await conn.sendVideoAsSticker(m.chat, media, msg, { packname: 'Ini Sticker cuy', author: 'BotTrinity' })
await fs.unlinkSync(encmedia)
} else {
reply(`Kirim Foto/Video dengan perintah ${prefix + command}\nVideo Durasi 1-9 detik`)
}
break/*
...
conn.sendMessage(from, { stic\ker: fs.readFileSync(`./${rand2}`) }, { packname: 'Ini Sticker cuy', author: 'BotTrinity' }, { quoted: msg })
fs.unlinkSync(`./${rand1}`)
...
.on("end", () => {
exec(`webpmux -set exif ./sticker/data.exif ./${rand2} -o ./${rand2}`, async (error) => {
conn.sendMessage(from, { sticker: fs.readFileSync(`./${rand2}`) }, { packname: 'Ini Sticker cuy', author: 'BotTrinity' }, { quoted: msg })
fs.unlinkSync(`./${rand1}`)
fs.unlinkSync(`./${rand2}`)
fs.unlinkSync(buffer)
})
...
var dev = '628165458562@s.whatsapp.net'
if (num == dev) return reply('Itu developer gua')
if (num == sender) return reply('Itu Nomor Lu Kirimiri')
await sleep(3000)
